...
<body>
    <h2>Form Prediksi Pencocokan Produk</h2>
    <p>
        ...
        <div class="container">
            <div>
                <form action="/action_page.php">
                    <label>No KTP :</label>
                    <input type="text" name="ktp" placeholder="No KTP">

                    <label>Nama Lengkap :</label>
                    <input type="text" name="nama" placeholder="Your name..">

                    <label>Judul 1 :</label>
                    <input type="text" name="judul1" placeholder="Title 1..">

                    <label>Judul 2 :</label>
                    <input type="text" name="judul2" placeholder="Title 2..">
